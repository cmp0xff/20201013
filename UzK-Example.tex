...
\begin{align}
    ...
    \label{eq:packet-150}
\end{align}
    in contrast to the \underline{general integral} \footfullcite[sec.\ 3.1]{Evans2010}.
...
\begin{itemize}
    ...
    \underline{iteratively separated} \footfullcite[sec.\ 48]{landau1}, so that
...
trajectory} in the HJ formalism \footfullcite[sec.\ 47]{landau1}.
\end{itemize}
...
\begin{frame}{(3.2/4) Outlook}
    ...
    \begin{itemize}
        ...
        trajectory\footfullcite{Kiefer2019a}, which is \alert{absent} in
